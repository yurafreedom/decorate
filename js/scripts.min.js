! function(e, t) {
    ...
    k.fn = k.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || w(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], s !== (i = e[t]) && (c && i && (k.isPlainObject(i) || (r = Array.isArray(i))) ? (o = r ? (r = !1, n && Array.isArray(n) ? n : []) : n && k.isPlainObject(n) ? n : {}, s[t] = k.extend(c, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, k.extend({
    ...
    var d = function(n) {
        ...
        var e, d, x, o, s, f, h, g, b, l, c, _, C, a, T, m, u, v, y, k = "sizzle" + 1 * new Date,
            w = n.document,
            E = 0,
            i = 0,
            S = se(),
        ...
        try {
            P.apply(t = z.call(w.childNodes), w.childNodes), t[w.childNodes.length].nodeType
        } catch (n) {
            P = {
        ...
        function oe(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : w) !== C && _(t), t = t || C, T)) {
                if (11 !== h && (l = J.exec(e)))
                    if (r = l[1]) {
                        if (9 === h) {
                            if (!(s = t.getElementById(r))) return n;
                            if (s.id === r) return n.push(s), n
                        } else if (p && (s = p.getElementById(r)) && y(t, s) && s.id === r) return n.push(s), n
                    } else {
                    ...
                    if (1 !== h) p = t, u = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(ne, ie) : t.setAttribute("id", a = k), o = (c = f(e)).length; o--;) c[o] = "#" + a + " " + ve(c[o]);
                        u = c.join(","), p = ee.test(e) && ge(t.parentNode) || t
                    }
                    if (u) try {
                        return P.apply(n, p.querySelectorAll(u)), n
                    } catch (e) {} finally {
        ...
        for (e in d = oe.support = {}, s = oe.isXML = function(e) {
                var t = e && (e.ownerDocument || e).documentElement;
                return !!t && "HTML" !== t.nodeName
            }, _ = oe.setDocument = function(e) {
                var t, n, i = e ? e.ownerDocument || e : w;
                return i !== C && 9 === i.nodeType && i.documentElement && (a = (C = i).documentElement, T = !s(C), w !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)), d.attributes = le(function(e) {
                ...
                }, u = [], m = [], (d.qsa = K.test(C.querySelectorAll)) && (le(function(e) {
                    a.appendChild(e).innerHTML = "<a id='" + k + "'></a><select id='" + k + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || m.push("\\[" + M + "*(?:value|" + O + ")"), e.querySelectorAll("[id~=" + k + "-]").length || m.push("~="), e.querySelectorAll(":checked").length || m.push(":checked"), e.querySelectorAll("a#" + k + "+*").length || m.push(".#.+[+~]")
                }), le(function(e) {
                ...
                })), (d.matchesSelector = K.test(v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && le(function(e) {
                    d.disconnectedMatch = v.call(e, "*"), v.call(e, "[s!='']:x"), u.push("!=", R)
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !d.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === w && y(w, e) ? -1 : t === C || t.ownerDocument === w && y(w, t) ? 1 : l ? L(l, e) - L(l, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return c = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== C && _(e), t = t.replace(X, "='$1']"), d.matchesSelector && T && !D[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t))) try {
                    var n = v.call(e, t);
                ...
                var t, n = [],
                    i = 0,
                    r = 0;
                if (c = !d.detectDuplicates, l = !d.sortStable && e.slice(0), e.sort(j), c) {
                ...
                preFilter: {
                    ATTR: function(e) {
                        return e[1] = e[1].replace(te, p), e[3] = (e[3] || e[4] || e[5] || "").replace(te, p), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
                    },
                    CHILD: function(e) {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return Q.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && V.test(n) && (t = f(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                        var t = e.replace(te, p).toLowerCase();
                        return "*" === e ? function() {
                            return !0
                        } : function(e) {
                        ...
                        return 1 === g && 0 === m ? function(e) {
                            ...
                            if (u) {
                                if (v) {
                                    for (; c;) {
                                        for (s = e; s = s[c];)
                                            if (w ? s.nodeName.toLowerCase() === p : 1 === s.nodeType) return !1;
                                        l = c = "only" === f && !l && "nextSibling"
                                    }
                                    return !0
                                }
                                if (l = [y ? u.firstChild : u.lastChild], y && h) {
                                    for (d = (a = (i = (r = (o = (s = u)[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[f] || [])[0] === E && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (d = a = 0) || l.pop();)
                                        if (1 === s.nodeType && ++d && s === e) {
                                            r[f] = [E, a, d];
                                            break
                                        }
                                } else if (h && (d = a = (i = (r = (o = (s = e)[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[f] || [])[0] === E && i[1]), !1 === d)
                                    for (;
                                        (s = ++a && s && s[c] || (d = a = 0) || l.pop()) && ((w ? s.nodeName.toLowerCase() !== p : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[f] = [E, d]), s !== e)););
                ...
                pseudos: {
                    ...
                    contains: ae(function(t) {
                        return t = t.replace(te, p),
                            function(e) {
                                return -1 < (e.textContent || e.innerText || o(e)).indexOf(t)
                            }
                    }),
                    lang: ae(function(n) {
                        return Z.test(n || "") || oe.error("unsupported lang: " + n), n = n.replace(te, p).toLowerCase(),
                            function(e) {
                                var t;
                                do {
        ...
        function ye(a, e, t) {
            ...
            return e.first ? function(e, t, n) {
                for (; e = e[l];)
                    if (1 === e.nodeType || p) return a(e, t, n);
                return !1
            } : function(e, t, n) {
                var i, r, o, s = [E, h];
                if (n) {
                    for (; e = e[l];)
                        if ((1 === e.nodeType || p) && a(e, t, n)) return !0
                } else
                    for (; e = e[l];)
                        if (1 === e.nodeType || p)
                            if (r = (o = e[k] || (e[k] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
                            else {
                                if ((i = r[u]) && i[0] === E && i[1] === h) return s[2] = i[2];
        ...
        function be(d, f, g, m, v, e) {
            return m && !m[k] && (m = be(m)), v && !v[k] && (v = be(v, e)), ae(function(e, t, n, i) {
                var r, o, s, a = [],
                    ...
                    p = !d || !e && f ? u : xe(u, a, d, n, i),
                    h = g ? v || (e ? d : c || m) ? [] : t : p;
                if (g && g(p, h, n, i), m)
                    for (r = xe(h, l), m(r, [], n, i), o = r.length; o--;)(s = r[o]) && (h[l[o]] = !(p[l[o]] = s));
                if (e) {
                    if (v || d) {
                        if (v) {
                            for (r = [], o = h.length; o--;)(s = h[o]) && r.push(p[o] = s);
                            v(null, h = [], r, i)
                        }
                        for (o = h.length; o--;)(s = h[o]) && -1 < (r = v ? L(e, s) : a[o]) && (e[r] = !(t[r] = s))
                    }
                } else h = xe(h === t ? h.splice(c, h.length) : h), v ? v(null, t, h, i) : P.apply(t, h)
            })
        }
        ...
        function _e(e) {
            for (var r, t, n, i = e.length, o = x.relative[e[0].type], s = o || x.relative[" "], a = o ? 1 : 0, l = ye(function(e) {
                ...
                if (t = x.relative[e[a].type]) u = [ye(we(u), t)];
                else {
                    if ((t = x.filter[e[a].type].apply(null, e[a].matches))[k]) {
                        for (n = ++a; n < i && !x.relative[e[n].type]; n++);
                        return be(1 < a && we(u), 1 < a && ve(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(W, "$1"), t, a < n && _e(e.slice(a, n)), n < i && _e(e = e.slice(n)), n < i && ve(e))
                    }
                    u.push(t)
                } return we(u)
        }
        return me.prototype = x.filters = x.pseudos, x.setFilters = new me, f = oe.tokenize = function(e, t) {
            var n, i, r, o, s, a, l, c = $[e + " "];
            if (c) return t ? 0 : c.slice(0);
            for (s = e, a = [], l = x.preFilter; s;) {
                for (o in n && !(i = F.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(r = [])), n = !1, (i = U.exec(s)) && (n = i.shift(), r.push({
                        value: n,
                        type: i[0].replace(W, " ")
            ...
            return t ? s.length : s ? oe.error(e) : $(e, a).slice(0)
        }, h = oe.compile = function(e, t) {
            var n, i = [],
                r = [],
                o = D[e + " "];
            if (!o) {
                for (t || (t = f(e)), n = t.length; n--;)(o = _e(t[n]))[k] ? i.push(o) : r.push(o);
                (o = D(e, function(m, v) {
                    function e(e, t, n, i, r) {
                        ...
                        for (r && (b = t === C || t || r); c !== g && null != (o = d[c]); c++) {
                            if (w && o) {
                                for (s = 0, t || o.ownerDocument === C || (_(o), n = !T); a = m[s++];)
                                    if (a(o, t || C, n)) {
                                        i.push(o);
                                        break
                                    } r && (E = f)
                        ...
                        if (l += c, y && c !== l) {
                            ...
                            if (e) {
                                if (0 < l)
                                    for (; c--;) u[c] || p[c] || (p[c] = I.call(i));
                                p = xe(p)
                            }
                            P.apply(i, p), r && !e && 0 < p.length && 1 < l + v.length && oe.uniqueSort(i)
                        }
                        return r && (E = f, b = h), u
                    }
                    var y = 0 < v.length,
            ...
            if (n = n || [], 1 === u.length) {
                if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === t.nodeType && T && x.relative[o[1].type]) {
                    if (!(t = (x.find.ID(s.matches[0].replace(te, p), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = Q.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !x.relative[a = s.type]);)
                    if ((l = x.find[a]) && (i = l(s.matches[0].replace(te, p), ee.test(o[0].type) && ge(t.parentNode) || t))) {
                        if (o.splice(r, 1), !(e = i.length && ve(o))) return P.apply(n, i), n;
                        break
                    }
            }
            return (c || h(e, u))(i, t, !T, n, !t || ee.test(e) && ge(t.parentNode) || t), n
        }, d.sortStable = k.split("").sort(j).join("") === k, d.detectDuplicates = !!c, _(), d.sortDetached = le(function(e) {
    ...
    function D(e, n, i) {
        return w(n) ? k.grep(e, function(e, t) {
    ...
    (k.fn.init = function(e, t, n) {
        var i, r;
        if (!e) return this;
        if (n = n || j, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : w(e) ? void 0 !== n.ready ? n.ready(e) : e(k) : k.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : A.exec(e)) || !i[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
        if (i[1]) {
            if (t = t instanceof k ? t[0] : t, k.merge(this, k.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), $.test(i[1]) && k.isPlainObject(t))
                for (i in t) w(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
        return (r = T.getElementById(i[2])) && (this[0] = r, this.length = 1), this
    }).prototype = k.fn, j = k(T);
    ...
    k.fn.extend({
        ...
        k.fn[i] = function(e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = k.filter(t, n)), 1 < this.length && (N[i] || k.uniqueSort(n), I.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var z = /[^\x20\t\r\n\f]+/g;
    ...
    function M(e, t, n, i) {
        var r;
        try {
            e && w(r = e.promise) ? r.call(e).done(t).fail(n) : e && w(r = e.then) ? r.call(e, t, n) : t.apply(void 0, [e].slice(i))
        } catch (e) {
            n.apply(void 0, [e])
        }
    }
    k.Callbacks = function(i) {
        i = "string" == typeof i ? function(e) {
            var n = {};
            return k.each(e.match(z) || [], function(e, t) {
                n[t] = !0
            }), n
        }(i) : k.extend({}, i);
                ...
                add: function() {
                    return s && (e && !r && (l = s.length - 1, a.push(e)), function n(e) {
                        k.each(e, function(e, t) {
                            w(t) ? i.unique && c.has(t) || s.push(t) : t && t.length && "string" !== b(t) && n(t)
                        })
                ...
                s = {
                    ...
                    then: function(t, n, i) {
                            ...
                            return function() {
                                function e() {
                                    ...
                                    if (!(r < l)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, w(t) ? a ? t.call(e, c(l, o, L, a), c(l, o, O, a)) : (l++, t.call(e, c(l, o, L, a), c(l, o, O, a), c(l, o, L, o.notifyWith))) : (s !== L && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                                    t = a ? e : function() {
                                        try {
                                            ...
                                            k.Deferred.exceptionHook && k.Deferred.exceptionHook(e, t.stackTrace), l <= r + 1 && (s !== O && (n = void 0, i = [e]), o.rejectWith(n, i))
                                        }
                                    };
                        ...
                        return k.Deferred(function(e) {
                            o[0][3].add(c(0, e, w(i) ? i : L, e.notifyWith)), o[1][3].add(c(0, e, w(t) ? t : L)), o[2][3].add(c(0, e, w(n) ? n : O))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            var n = arguments.length,
                ...
                o = a.call(arguments),
                s = k.Deferred();
            if (n <= 1 && (M(e, s.done(t(i)).resolve, s.reject, !n), "pending" === s.state() || w(o[i] && o[i].then))) return s.then();
    ...
    k.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --k.readyWait : k.isReady) || ((k.isReady = !0) !== e && 0 < --k.readyWait || q.resolveWith(T, [k]))
        }
    }), k.ready.then = q.then, "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? C.setTimeout(k.ready) : (T.addEventListener("DOMContentLoaded", R), C.addEventListener("load", R));
    var B = function(e, t, n, i, r, o, s) {
            ...
            else if (void 0 !== i && (r = !0, w(i) || (s = !0), c && (t = s ? (t.call(e, i), null) : (c = t, function(e, t, n) {
                    return c.call(k(e), n)
                })), t))
    ...
    k.extend({
        ...
        data: function(n, e) {
            ...
            if (this.length && (r = Y.get(o), 1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--;) s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = X(i.slice(5)), J(o, i, r[i]));
    ...
    function oe(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; s--;) k.style(e, t, u + c), (1 - o) * (1 - (o = a() / l || .5)) <= 0 && (s = 0), u /= o;
    ...
    function ae(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)(i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = Q.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && re(i) && (r[o] = (p = c = l = void 0, c = (a = i).ownerDocument, u = a.nodeName, (p = se[u]) || (l = c.body.appendChild(c.createElement(u)), p = k.css(l, "display"), l.parentNode.removeChild(l), "none" === p && (p = "block"), se[u] = p)))) : "none" !== n && (r[o] = "none", Q.set(i, "display", n)));
        var a, l, c, u, p;
    ...
    function ve(e, t, n, i, r) {
        for (var o, s, a, l, c, u, p = t.createDocumentFragment(), h = [], d = 0, f = e.length; d < f; d++)
            if ((o = e[d]) || 0 === o)
                if ("object" === b(o)) k.merge(h, o.nodeType ? [o] : o);
                else if (me.test(o)) {
            for (s = s || p.appendChild(t.createElement("div")), a = (ce.exec(o) || ["", ""])[1].toLowerCase(), l = pe[a] || pe._default, s.innerHTML = l[1] + k.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            k.merge(h, s.childNodes), (s = p.firstChild).textContent = ""
        } else h.push(t.createTextNode(o));
        for (p.textContent = "", d = 0; o = h[d++];)
            if (i && -1 < k.inArray(o, i)) r && r.push(o);
            else if (c = k.contains(o.ownerDocument, o), s = he(p.appendChild(o), "script"), c && de(s), n)
    ...
    k.event = {
        ...
        add: function(t, e, n, i, r) {
            var o, s, a, l, c, u, p, h, d, f, g, m = Q.get(t);
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && k.find.matchesSelector(ye, r), n.guid || (n.guid = k.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                        return void 0 !== k && k.event.triggered !== e.type ? k.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(z) || [""]).length; c--;) d = g = (a = be.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), d && (p = k.event.special[d] || {}, d = (r ? p.delegateType : p.bindType) || d, p = k.event.special[d] || {}, u = k.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, o), (h = l[d]) || ((h = l[d] = []).delegateCount = 0, p.setup && !1 !== p.setup.call(t, i, f, s) || t.addEventListener && t.addEventListener(d, s)), p.add && (p.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), r ? h.splice(h.delegateCount++, 0, u) : h.push(u), k.event.global[d] = !0)
        },
        remove: function(e, t, n, i, r) {
            var o, s, a, l, c, u, p, h, d, f, g, m = Q.hasData(e) && Q.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(z) || [""]).length; c--;)
                    if (d = g = (a = be.exec(t[c]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                        for (p = k.event.special[d] || {}, h = l[d = (i ? p.delegateType : p.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = h.length; o--;) u = h[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(o, 1), u.selector && h.delegateCount--, p.remove && p.remove.call(e, u));
                        s && !h.length && (p.teardown && !1 !== p.teardown.call(e, f, m.handle) || k.removeEvent(e, d, m.handle), delete l[d])
                    } else
                        for (d in l) k.event.remove(e, d + t[c], n, i, !0);
                k.isEmptyObject(l) && Q.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, o, s, a = k.event.fix(e),
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? _e : Ce, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && k.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[k.expando] = !0
    }, k.Event.prototype = {
        constructor: k.Event,
    ...
    function Ne(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Y.hasData(e) && (a = Y.access(e), l = k.extend({}, a), Y.set(t, l))
        }
    }
    ...
    function Pe(n, i, r, o) {
        ...
        var e, t, s, a, l, c, u = 0,
            ...
            d = i[0],
            f = w(d);
        if (f || 1 < p && "string" == typeof d && !y.checkClone && $e.test(d)) return n.each(function(e) {
            var t = n.eq(e);
            f && (i[0] = d.call(this, e, t.html())), Pe(t, i, r, o)
        });
        if (p && (t = (e = ve(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = k.map(he(e, "script"), Ae)).length; u < p; u++) l = e, u !== h && (l = k.clone(l, !0, !0), a && k.merge(s, he(l, "script"))), r.call(n[u], l, u);
            if (a)
                for (c = s[s.length - 1].ownerDocument, k.map(s, Ie), u = 0; u < a; u++) l = s[u], ue.test(l.type || "") && !Q.access(l, "globalEval") && k.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? k._evalUrl && k._evalUrl(l.src) : x(l.textContent.replace(De, ""), c, l))
        }
        return n
    }

    function ze(e, t, n) {
        for (var i, r = t ? k.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || k.cleanData(he(i)), i.parentNode && (n && k.contains(i.ownerDocument, i) && de(he(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    k.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || he(e), s = s || he(u), i = 0, r = o.length; i < r; i++) Ne(o[i], s[i]);
                else Ne(e, u);
            return 0 < (s = he(u, "script")).length && de(s, !p && he(e, "script")), u
        },
    ...
    var Le, Oe, Me, He, qe, Re, Be, We = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"),
        Fe = function(e) {
    ...
    function Xe() {
        if (Be) {
            Re.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Be.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ye.appendChild(Re).appendChild(Be);
            var e = C.getComputedStyle(Be);
            Le = "1%" !== e.top, qe = 12 === Ve(e.marginLeft), Be.style.right = "60%", He = 36 === Ve(e.right), Oe = 36 === Ve(e.width), Be.style.position = "absolute", Me = 36 === Be.offsetWidth || "absolute", ye.removeChild(Re), Be = null
        }
    }
    ...
    function Ze(e, t, n) {
        ...
        return (n = n || Fe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || k.contains(e.ownerDocument, e) || (s = k.style(e, t)), !y.pixelBoxStyles() && We.test(s) && Ue.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    Re = T.createElement("div"), (Be = T.createElement("div")).style && (Be.style.backgroundClip = "content-box", Be.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Be.style.backgroundClip, k.extend(y, {
    ...
    function rt(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2) "margin" === n && (l += k.css(e, n + ie[s], !0, r)), i ? ("content" === n && (l -= k.css(e, "padding" + ie[s], !0, r)), "margin" !== n && (l -= k.css(e, "border" + ie[s] + "Width", !0, r))) : (l += k.css(e, "padding" + ie[s], !0, r), "padding" !== n ? l += k.css(e, "border" + ie[s] + "Width", !0, r) : a += k.css(e, "border" + ie[s] + "Width", !0, r));
    ...
    function ot(e, t, n) {
        ...
        return s = s && (y.boxSizingReliable() || r === e.style[t]), "auto" !== r && (parseFloat(r) || "inline" !== k.css(e, "display", !1, i)) || (r = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (r = parseFloat(r) || 0) + rt(e, t, n || (o ? "border" : "content"), s, i, r) + "px"
    }
    ...
    k.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = X(t),
                    l = Ge.test(t),
                    c = e.style;
                if (l || (t = nt(a)), s = k.cssHooks[t] || k.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
                "string" == (o = typeof n) && (r = ne.exec(n)) && r[1] && (n = oe(e, t, r), o = "number"), null != n && n == n && ("number" === o && (n += r && r[3] || (k.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = X(t);
            return Ge.test(t) || (t = nt(a)), (s = k.cssHooks[t] || k.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Ze(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), k.each(["height", "width"], function(e, a) {
        k.cssHooks[a] = {
            get: function(e, t, n) {
                if (t) return !Ye.test(k.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ot(e, a, n) : ee(e, Ke, function() {
                    return ot(e, a, n)
                })
            },
            set: function(e, t, n) {
                var i, r = Fe(e),
                    ...
                    s = n && rt(e, a, n, o, r);
                return o && y.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - rt(e, a, "border", !1, r) - .5)), s && (i = ne.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t, t = k.css(e, a)), it(0, t, s)
            }
        }
    }), k.cssHooks.marginLeft = Qe(y.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(Ze(e, "marginLeft")) || e.getBoundingClientRect().left - ee(e, {
            marginLeft: 0
        }, function() {
        ...
        }, "margin" !== r && (k.cssHooks[r + o].set = it)
    }), k.fn.extend({
        css: function(e, t) {
    ...
    var at, lt, ct, ut, pt = /^(?:toggle|show|hide)$/,
        ht = /queueHooks$/;

    function dt() {
        lt && (!1 === T.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(dt) : C.setTimeout(dt, k.fx.interval), k.fx.tick())
    }
    ...
    function vt(o, e, t) {
        var n, s, i = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var e = at || ft(), t = Math.max(0, c.startTime + c.duration - e), n = 1 - (t / c.duration || 0), i = 0, r = c.tweens.length; i < r; i++) c.tweens[i].run(n);
        ...
        for (function(e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (r = t[i = X(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = k.cssHooks[i]) && "expand" in s)
                        for (n in o = s.expand(o), delete e[i], o) n in e || (e[n] = o[n], t[n] = r);
                    else t[i] = r
            }(u, c.opts.specialEasing); i < r; i++)
            if (n = vt.prefilters[i].call(c, o, u, c.opts)) return w(n.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
        return k.map(u, mt, c), w(c.opts.start) && c.opts.start.call(o, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), k.fx.timer(k.extend(l, {
            elem: o,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    k.Animation = k.extend(vt, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, r = (e = w(e) ? (t = e, ["*"]) : e.match(z)).length; i < r; i++) n = e[i], vt.tweeners[n] = vt.tweeners[n] || [], vt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (s = k._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (i in p && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = m && m.display) && (c = Q.get(e, "display")), "none" === (u = k.css(e, "display")) && (c ? u = c : (ae([e], !0), c = e.style.display || c, u = k.css(e, "display"), ae([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === k.css(e, "float") && (l || (h.done(function() {
                        f.display = c
                    ...
                    for (i in g || ae([e]), Q.remove(e, "fxshow"), d) k.style(e, i, d[i])
                })), l = mt(g ? m[i] : 0, i, h), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
    ...
    }, ct = T.createElement("input"), ut = T.createElement("select").appendChild(T.createElement("option")), ct.type = "checkbox", y.checkOn = "" !== ct.value, y.optSelected = ut.selected, (ct = T.createElement("input")).value = "t", ct.type = "radio", y.radioValue = "t" === ct.value;
    var yt, wt = k.expr.attrHandle;
    k.fn.extend({
        attr: function(e, t) {
    ...
    k.fn.extend({
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : w(r) ? this.each(function(e) {
                k(this).toggleClass(r.call(this, e, Ct(this), t), t)
            }) : this.each(function() {
                var e, t, n, i;
                if (s)
                    for (t = 0, n = k(this), i = Tt(r); e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else void 0 !== r && "boolean" != o || ((e = Ct(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : Q.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + _t(Ct(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var kt = /\r/g;
    k.fn.extend({
        val: function(n) {
            var i, e, r, t = this[0];
            return arguments.length ? (r = w(n), this.each(function(e) {
                var t;
    ...
    k.extend(k.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, c, u, p, h = [n || T],
                d = v.call(e, "type") ? e.type : e,
                f = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = p = s = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !St.test(d + k.event.triggered) && (-1 < d.indexOf(".") && (d = (f = d.split(".")).shift(), f.sort()), l = d.indexOf(":") < 0 && "on" + d, (e = e[k.expando] ? e : new k.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : k.makeArray(t, [e]), u = k.event.special[d] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || d, St.test(a + d) || (o = o.parentNode); o; o = o.parentNode) h.push(o), s = o;
                    s === (n.ownerDocument || T) && h.push(s.defaultView || s.parentWindow || C)
                }
                for (r = 0;
                    (o = h[r++]) && !e.isPropagationStopped();) p = o, e.type = 1 < r ? a : u.bindType || d, (c = (Q.get(o, "events") || {})[e.type] && Q.get(o, "handle")) && c.apply(o, t), (c = l && o[l]) && c.apply && V(o) && (e.result = c.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = d, i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !V(n) || l && w(n[d]) && !g(n) && ((s = n[l]) && (n[l] = null), k.event.triggered = d, e.isPropagationStopped() && p.addEventListener(d, Et), n[d](), e.isPropagationStopped() && p.removeEventListener(d, Et), k.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    function zt(n, e, i, r) {
        ...
        if (Array.isArray(e)) k.each(e, function(e, t) {
            i || At.test(n) ? r(n, t) : zt(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, r)
        });
    ...
    k.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !k(this).is(":disabled") && Pt.test(this.nodeName) && !Nt.test(e) && (this.checked || !le.test(e))
            }).map(function(e, t) {
                var n = k(this).val();
    ...
    Ut.href = $t.href, k.extend({
        ...
        ajax: function(e, t) {
            ...
            var u, p, h, n, d, i, f, g, r, o, m = k.ajaxSetup({}, t),
                v = m.context || m,
                ...
                _ = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (f) {
                            if (!n)
                                for (n = {}; t = Ht.exec(h);) n[t[1].toLowerCase()] = t[2];
                            t = n[e.toLowerCase()]
                        }
            ...
            if (w.promise(_), m.url = ((e || m.url || $t.href) + "").replace(Rt, $t.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(z) || [""], null == m.crossDomain) {
                i = T.createElement("a");
                try {
            ...
            if (m.data && m.processData && "string" != typeof m.data && (m.data = k.param(m.data, m.traditional)), Vt(Bt, m, t, _), f) return _;
            for (r in (g = k.event && m.global) && 0 == k.active++ && k.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !qt.test(m.type), p = m.url.replace(Ot, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Lt, "+")) : (o = m.url.slice(p.length), m.data && (m.processData || "string" == typeof m.data) && (p += (jt.test(p) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (p = p.replace(Mt, "$1"), o = (jt.test(p) ? "&" : "?") + "_=" + Dt++ + o), m.url = p + o), m.ifModified && (k.lastModified[p] && _.setRequestHeader("If-Modified-Since", k.lastModified[p]), k.etag[p] && _.setRequestHeader("If-None-Match", k.etag[p])), (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && _.setRequestHeader("Content-Type", m.contentType), _.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : m.accepts["*"]), m.headers) _.setRequestHeader(r, m.headers[r]);
            if (m.beforeSend && (!1 === m.beforeSend.call(v, _, m) || f)) return _.abort();
            if (l = "abort", x.add(m.complete), _.done(m.success), _.fail(m.error), u = Vt(Wt, m, t, _)) {
            ...
            function c(e, t, n, i) {
                var r, o, s, a, l, c = t;
                f || (f = !0, d && C.clearTimeout(d), u = void 0, h = i || "", _.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
                ...
                }(m, a, _, r), r ? (m.ifModified && ((l = _.getResponseHeader("Last-Modified")) && (k.lastModified[p] = l), (l = _.getResponseHeader("etag")) && (k.etag[p] = l)), 204 === e || "HEAD" === m.type ? c = "nocontent" : 304 === e ? c = "notmodified" : (c = a.state, o = a.data, r = !(s = a.error))) : (s = c, !e && c || (c = "error", e < 0 && (e = 0))), _.status = e, _.statusText = (t || c) + "", r ? w.resolveWith(v, [o, c, _]) : w.rejectWith(v, [_, c, s]), _.statusCode(b), b = void 0, g && y.trigger(r ? "ajaxSuccess" : "ajaxError", [_, m, r ? o : s]), x.fireWith(v, [_, c]), g && (y.trigger("ajaxComplete", [_, m]), --k.active || k.event.trigger("ajaxStop")))
            }
            return _
        },
        ...
        k[r] = function(e, t, n, i) {
            return w(t) && (i = i || n, n = t, t = void 0), k.ajax(k.extend({
                url: e,
                type: r,
                dataType: i,
                data: t,
        ...
        wrapAll: function(e) {
            var t;
            return this[0] && (w(e) && (e = e.call(this[0])), t = k(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() {
    ...
    y.cors = !!Yt && "withCredentials" in Yt, y.ajax = Yt = !!Yt, k.ajaxTransport(function(r) {
        var o, s;
    ...
    k.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = w(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Jt, "$1" + i) : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
            return o || k.error(i + " was not called"), o[0]
        }, e.dataTypes[0] = "json", r = C[i], C[i] = function() {
            o = arguments
        }, n.always(function() {
            void 0 === r ? k(C).removeProp(i) : C[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, Kt.push(i)), o && w(r) && r(o[0]), o = r = void 0
        }), "script"
    }), y.createHTMLDocument = ((Gt = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Gt.childNodes.length), k.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((i = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, t.head.appendChild(i)) : t = T), o = !n && [], (r = $.exec(e)) ? [t.createElement(r[1])] : (r = ve([e], t, o), o && o.length && k(o).remove(), k.merge([], r.childNodes)));
        var i, r, o
    }, k.fn.load = function(e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = _t(e.slice(a)), e = e.slice(0, a)), w(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && k.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, c = k.css(e, "position"),
                u = k(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), o = k.css(e, "top"), l = k.css(e, "left"), r = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (i = u.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), w(t) && (t = t.call(e, n, k.extend({}, a))), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + r), "using" in t ? t.using.call(e, p) : u.css(p)
        }
    }, k.fn.extend({
        offset: function(t) {
        ...
        k.cssHooks[n] = Qe(y.pixelPosition, function(e, t) {
            if (t) return t = Ze(e, n), We.test(t) ? k(e).position()[n] + "px" : t
        })
    }), k.each({
        Height: "height",
        Width: "width"
        ...
        k.each({
            ...
            k.fn[o] = function(e, t) {
                ...
                return B(this, function(e, t, n) {
                    var i;
                    return g(e) ? 0 === o.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (i = e.documentElement, Math.max(e.body["scroll" + s], i["scroll" + s], e.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? k.css(e, t, r) : k.style(e, t, n, r)
                }, a, n ? e : void 0, n)
            }
        })
        ...
        var n, i, r;
        if ("string" == typeof t && (n = e[t], t = e, e = n), w(e)) return i = a.call(arguments, 2), (r = function() {
            return e.apply(t || this, i.concat(a.call(arguments)))
        }).guid = e.guid = e.guid || k.guid++, r
    }, k.holdReady = function(e) {
        e ? k.readyWait++ : k.ready(!0)
    }, k.isArray = Array.isArray, k.parseJSON = JSON.parse, k.nodeName = S, k.isFunction = w, k.isWindow = g, k.camelCase = X, k.type = b, k.now = Date.now, k.isNumeric = function(e) {
        var t = k.type(e);
...
function(e) {
    ...
    e.prototype = {
        ...
        open: function(e) {
            ...
            if (!g.isOpen) {
                ...
                d("BeforeOpen"), g.st.showCloseBtn && (g.st.closeBtnInside ? (p(y, function(e, t, n, i) {
                    ...
                    height: m.height(),
                    position: "absolute"
                }), g.st.enableEscapeKey && m.on("keyup" + x, function(e) {
                    27 === e.keyCode && g.close()
                }), _.on("resize" + x, function() {
                    g.updateSize()
                ...
                return g.isIE7 && (c += " mfp-ie7"), c && g._addClassToMFP(c), g.updateItemHTML(), d("BuildControls"), u("html").css(a), g.bgOverlay.add(g.wrap).prependTo(g.st.prependTo || u(document.body)), g._lastFocusedEl = document.activeElement, setTimeout(function() {
                    g.content ? (g._addClassToMFP(b), g._setFocus()) : g.bgOverlay.addClass(b), m.on("focusin" + x, g._onFocusIn)
                }, 16), g.isOpen = !0, g.updateSize(s), d(w), e
            }
            g.updateItemHTML()
        },
        close: function() {
            g.isOpen && (d(c), g.isOpen = !1, g.st.removalDelay && !g.isLowIE && g.supportsTransition ? (g._addClassToMFP(n), setTimeout(function() {
                g._close()
        ...
        updateSize: function(e) {
            ...
            } else g.wH = e || _.height();
            g.fixedContentPos || g.wrap.css("height", g.wH), d("Resize")
        },
        updateItemHTML: function() {
            var e = g.items[g.index];
            g.contentContainer.detach(), g.content && g.content.detach(), e.parsed || (e = g.parseEl(g.index));
            var t = e.type;
            if (d("BeforeChange", [g.currItem ? g.currItem.type : "", t]), g.currItem = e, !g.currTemplate[t]) {
                var n = !!g.st[t] && g.st[t].markup;
                d("FirstMarkupParse", n), g.currTemplate[t] = !n || u(n)
            }
            r && r !== e.type && g.container.removeClass("mfp-" + r + "-holder");
            var i = g["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, g.currTemplate[t]);
            g.appendContent(i, t), e.preloaded = !0, d("Change", e), r = e.type, g.container.prepend(g.contentContainer), d("AfterChange")
        },
        appendContent: function(e, t) {
            (g.content = e) ? g.st.showCloseBtn && g.st.closeBtnInside && !0 === g.currTemplate[t] ? g.content.find(".mfp-close").length || g.content.append(f()) : g.content = e: g.content = "", d("BeforeAppend"), g.container.addClass("mfp-" + t + "-holder"), g.contentContainer.append(g.content)
        },
        parseEl: function(e) {
            var t, n = g.items[e];
            if ((n = n.tagName ? {
            ...
            return n.type = t || g.st.type || "inline", n.index = e, n.parsed = !0, g.items[e] = n, d("ElementParse", n), g.items[e]
        },
        ...
        updateStatus: function(e, t) {
            if (g.preloader) {
                ...
                d("UpdateStatus", n), e = n.status, t = n.text, g.preloader.html(t), g.preloader.find("a").on("click", function(e) {
        ...
        _hasScrollBar: function(e) {
            return (g.isIE7 ? m.height() : document.body.scrollHeight) > (e || _.height())
        },
        _setFocus: function() {
            (g.st.focus ? g.content.find(g.st.focus).eq(0) : g.wrap).focus()
        },
        _onFocusIn: function(e) {
            return e.target === g.wrap[0] || u.contains(g.wrap[0], e.target) ? void 0 : (g._setFocus(), !1)
        },
        _parseMarkup: function(r, e, t) {
            var o;
            t.data && (e = u.extend(t.data, e)), d(y, [r, e, t]), u.each(e, function(e, t) {
        ...
        if ("string" == typeof e)
            if ("open" === e) {
                ...
                n = i.items ? i.items[r] : (n = t, i.delegate && (n = n.find(i.delegate)), n.eq(r)), g._openClick({
                    mfpEl: n
                }, t, i)
            } else g.isOpen && g[e].apply(g, Array.prototype.slice.call(arguments, 1));
        else e = u.extend(!0, {}, e), a ? t.data("magnificPopup", e) : t[0].magnificPopup = e, g.addGroup(t, e);
        return t
    };

    function C() {
        E && (k.after(E.addClass(T)).detach(), E = null)
    }
    var T, k, E, S = "inline";
            ...
            getInline: function(e, t) {
                if (C(), e.src) {
                    ...
                    if (i.length) {
                        ...
                        r && r.tagName && (k || (T = n.hiddenClass, k = h(T), T = "mfp-" + T), E = i.after(k).detach().removeClass(T)), g.updateStatus("ready")
    ...
    function $() {
        j && u(document.body).removeClass(j)
    }
    ...
    u.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                g.types.push(A), j = g.st.ajax.cursor, p(l + "." + A, D), p("BeforeChange." + A, D)
            },
            getAjax: function(r) {
                j && u(document.body).addClass(j), g.updateStatus("loading");
                var e = u.extend({
                    url: r.src,
                    success: function(e, t, n) {
                        ...
                        d("ParseAjax", i), g.appendContent(u(i.data), A), r.finished = !0, $(), g._setFocus(), setTimeout(function() {
                            g.wrap.addClass(b)
                        }, 16), g.updateStatus("ready"), d("AjaxContentAdded")
                    },
                    error: function() {
                        $(), r.finished = r.loadError = !0, g.updateStatus("error", g.st.ajax.tError.replace("%url%", r.src))
                    }
                }, g.st.ajax.settings);
    ...
    u.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var e = g.st.image,
                    t = ".image";
                g.types.push("image"), p(w + t, function() {
                    "image" === g.currItem.type && e.cursor && u(document.body).addClass(e.cursor)
                }), p(l + t, function() {
                    e.cursor && u(document.body).removeClass(e.cursor), _.off("resize" + x)
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, I && clearInterval(I), e.isCheckingImgSize = !1, d("ImageHasSize", e), e.imgHidden && (g.content && g.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    r = function(e) {
                        I && clearInterval(I), I = setInterval(function() {
                            return 0 < i.naturalWidth ? void g._onImageHasSize(t) : (200 < n && clearInterval(I), void(3 === ++n ? r(10) : 40 === n ? r(50) : 100 === n && r(500)))
                        }, e)
                    };
                r(1)
            },
            getImage: function(e, t) {
                var n = 0,
                    i = function() {
                        e && (e.img[0].complete ? (e.img.off(".mfploader"), e === g.currItem && (g._onImageHasSize(e), g.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, d("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : r())
                    },
                    r = function() {
                ...
                }, e), g.resizeImage(), e.hasSize ? (I && clearInterval(I), e.loadError ? (t.addClass("mfp-loading"), g.updateStatus("error", o.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), g.updateStatus("ready"))) : (g.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), g.findImageSize(e))), t
            }
        }
    });
    var N;
        ...
        proto: {
            initZoom: function() {
                ...
                if (o.enabled && g.supportsTransition) {
                    ...
                    var r, s, a = o.duration;
                    p("BuildControls" + t, function() {
                        if (g._allowZoom()) {
                            if (clearTimeout(r), g.content.css("visibility", "hidden"), !(e = g._getItemToZoom())) return void i();
                            (s = n(e)).css(g._getOffset()), g.wrap.append(s), r = setTimeout(function() {
                                s.css(g._getOffset(!0)), r = setTimeout(function() {
                                    i(), setTimeout(function() {
                                        s.remove(), e = s = null, d("ZoomAnimationEnded")
                                    }, 16)
                                }, a)
                            }, 16)
                        }
                        ...
                        if (g._allowZoom()) {
                            if (clearTimeout(r), g.st.removalDelay = a, !e) {
                                if (!(e = g._getItemToZoom())) return;
                                s = n(e)
                            }
                            s.css(g._getOffset(!0)), g.wrap.append(s), g.content.css("visibility", "hidden"), setTimeout(function() {
                                s.css(g._getOffset())
                            }, 16)
                        }
                    }), p(l + t, function() {
                        g._allowZoom() && (i(), s && s.remove(), e = null)
                    })
                }
            },
            _allowZoom: function() {
            ...
            _getOffset: function(e) {
                ...
                return void 0 === N && (N = void 0 !== document.createElement("p").style.MozTransform), N ? o["-moz-transform"] = o.transform = "translate(" + n.left + "px," + n.top + "px)" : (o.left = n.left, o.top = n.top), o
            }
        }
    });
    ...
    u.magnificPopup.registerModule(z, {
        ...
        proto: {
            initIframe: function() {
                g.types.push(z), p("BeforeChange", function(e, t, n) {
                    t !== n && (t === z ? P() : n === z && P(!0))
                }), p(l + "." + z, function() {
                    P()
                })
    ...
    u.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var o = g.st.gallery,
                    e = ".mfp-gallery";
                return g.direction = !0, !(!o || !o.enabled) && (v += " mfp-gallery", p(w + e, function() {
                    ...
                    t.text && (t.text = O(t.text, g.currItem.index, g.items.length))
                }), p(y + e, function(e, t, n, i) {
                    var r = g.items.length;
                    n.counter = 1 < r ? O(o.tCounter, i.index, r) : ""
                }), p("BuildControls" + e, function() {
                    if (1 < g.items.length && o.arrows && !g.arrowLeft) {
                        var e = o.arrowMarkup,
                            t = g.arrowLeft = u(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(s),
                            n = g.arrowRight = u(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(s);
                        t.click(function() {
                            g.prev()
                        }), n.click(function() {
                            g.next()
            ...
            _preloadItem: function(e) {
                if (e = L(e), !g.items[e].preloaded) {
                    var t = g.items[e];
                    t.parsed || (t = g.parseEl(e)), d("LazyLoad", t), "image" === t.type && (t.img = u('<img class="mfp-img" />').on("load.mfploader", function() {
                        t.hasSize = !0
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var n = g.st.retina,
                        i = n.ratio;
                    1 < (i = isNaN(i) ? i() : i) && (p("ImageHasSize." + M, function(e, t) {
                        t.img.css({
                            "max-width": t.img[0].naturalWidth / i,
                            width: "100%"
                        })
                    }), p("ElementParse." + M, function(e, t) {
...
function(y) {
    ...
    y.mask = {
        ...
        mask: function(t, d) {
            var n, f, g, m, v;
            return !t && 0 < this.length ? y(this[0]).data(y.mask.dataName)() : (d = y.extend({
                placeholder: y.mask.placeholder,
                completed: null
            }, d), n = y.mask.definitions, f = [], g = v = t.length, m = null, y.each(t.split(""), function(e, t) {
                "?" == t ? (v--, g = e) : n[t] ? (f.push(RegExp(n[t])), null === m && (m = f.length - 1)) : f.push(null)
                ...
                function a(e, t) {
                    ...
                    if (!(e < 0)) {
                        for (n = e, i = s(t); n < v; n++)
                            if (f[n]) {
                                if (!(i < v && f[n].test(p[i]))) break;
                                p[n] = p[i], p[i] = d.placeholder, i = s(i)
                ...
                function l(e, t) {
                    var n;
                    for (n = e; n < t && n < v; n++) f[n] && (p[n] = d.placeholder)
                }
                ...
                function o(e) {
                    ...
                    for (pos = t = 0; t < v; t++)
                        if (f[t]) {
                            for (p[t] = d.placeholder; pos++ < i.length;)
                                if (n = i.charAt(pos - 1), f[t].test(n)) {
                                    p[t] = n, r = t;
                                    break
                                } if (pos > i.length) break
                        } else p[t] === i.charAt(pos) && t !== g && (pos++, r = t);
                    return e ? c() : r + 1 < g ? (u.val(""), l(0, v)) : (c(), u.val(u.val().substring(0, r + 1))), g ? t : m
                }
                var u = y(this),
                    p = y.map(t.split(""), function(e) {
                        return "?" != e ? n[e] ? d.placeholder : e : void 0
                    }),
                    h = u.val();
                u.data(y.mask.dataName, function() {
                    return y.map(p, function(e, t) {
                        return f[t] && e != d.placeholder ? e : null
                    }).join("")
                }), u.attr("readonly") || u.one("unmask", function() {
                    u.unbind(".mask").removeData(y.mask.dataName)
                }).bind("focus.mask", function() {
                    var e;
                    clearTimeout(i), h = u.val(), e = o(), i = setTimeout(function() {
                    ...
                    var t, n, i, r = e.which;
                    8 === r || 46 === r || w && 127 === r ? (n = (t = u.caret()).begin, 0 == (i = t.end) - n && (n = 46 !== r ? function(e) {
                        for (; 0 <= --e && !f[e];);
                        return e
                    }(n) : i = s(n - 1), i = 46 === r ? s(i) : i), l(n, i), a(n, i - 1), e.preventDefault()) : 27 == r && (u.val(h), u.caret(0, o()), e.preventDefault())
                }).bind("keypress.mask", function(e) {
                    var t, n, i, r = e.which,
                        o = u.caret();
                    e.ctrlKey || e.altKey || e.metaKey || r < 32 || r && (0 != o.end - o.begin && (l(o.begin, o.end), a(o.begin, o.end - 1)), (t = s(o.begin - 1)) < v && (n = String.fromCharCode(r), f[t].test(n) && (function(e) {
                        var t, n, i, r;
                        for (t = e, n = d.placeholder; t < v; t++)
                            if (f[t]) {
                                if (i = s(t), r = p[t], p[t] = n, !(i < v && f[i].test(r))) break;
                                n = r
                            }
                    }(t), p[t] = n, c(), i = s(t), x ? setTimeout(y.proxy(y.fn.caret, u, i), 0) : u.caret(i), d.completed && v <= i && d.completed.call(u))), e.preventDefault())
                }).bind(r, function() {
                    setTimeout(function() {
                        var e = o(!0);
                        u.caret(e), d.completed && e == u.val().length && d.completed.call(u)
                    }, 0)
                }), o()
            }))
        }
...
function(r, e, t, o) {
    ...
    function i(e) {
        $(e).addClass("dash").siblings().removeClass("dash").parents(".steps").find(".steps_text").eq($(e).index()).addClass("dash").siblings(".steps_text").removeClass("dash")
    }
    $(".steps_tabs_tab").delegate("li:not(.dash)", "click", function(e) {
        i(this)
    }), $(".controls .prev").click(function(e) {
        e.preventDefault();
        var t = $(".dash").index(),
            n = $("ul.steps_tabs_tab > li");
        t = t < 1 ? n.length - 1 : t - 1, i(n.get(t))
    }), $(".controls .next").click(function(e) {
        e.preventDefault();
        var t = $(".dash").index(),
            n = $("ul.steps_tabs_tab > li");
        t = ++t % n.length, i(n.get(t))
    }), $(document).on("touchstart  mousedown", function(e) {
        0 === $(e.target).closest(".menu").length && $(".menu").removeClass("active")
    }), $(".p-form .close").on("click", function() {
        $.magnificPopup.close()
    }), 
    // $(document).on("touchstart  mousedown", function(e) {
    //     0 === $(e.target).closest(".modal_window").length && ($(".modal").fadeOut(600), $(".modal_window").removeClass("active"))
    // }), 
    // $(document).on("touchstart  mousedown", function(e) {
    //     0 === $(e.target).closest(".modal_neural").length && ($(".modal").fadeOut(600), $(".modal_neural").removeClass("active"))
    // }),
    $(".mobile_advantage_cont").find(".btn_toggle").on("click", function() {
        $(this).parent().find(".mobile_advantage_item").slideToggle("60"), $(this).toggleClass("active")
    }), $(".f_phone").mask("+7 (999) 999-99-99"), $(".slide_wrapp, .reviews_slider, .mobile_advantage_item_slider, .steps_slider, .works_slider").owlCarousel({
        loop: !0,
        items: 1,
        margin: 0,
        center: !0,
    ...
    }), $(".btn_checked span").on("click", function() {
        $(".api_check_slidejs").slideDown(), $(this).parent().hide(300)
    }), $(".call").click(function(e) {
        e.preventDefault(), $.magnificPopup.close();
        var t = $(this).attr("href");
        $(".modal").is(":hidden") && ($(".modal").fadeIn(600), $(t).addClass("active"))
    }), $(".modal_window .close").click(function() {
        $(".modal").is(":visible") && ($(".modal").fadeOut(600), $(".modal_window").removeClass("active"))
    }), $(".modal_neural .close").click(function() {
        $(".modal").is(":visible") && ($(".modal").fadeOut(600), $(".modal_neural").removeClass("active"))
    }),
    $(".header_content .btn_b").click(function(e) {
        e.preventDefault(), $("html,body").animate({
            scrollTop: $(".works").offset().top - 60
        })
    }), $(".header_wrapp .top_line .menu_btn").click(function() {
        $(".menu").addClass("active")
    }), $(".menu .close").click(function() {
        $(".menu").removeClass("active")
    }), $(".menu nav ul li a").click(function() {
        $(".menu").removeClass("active")
    }), $(".form, .formit").submit(function() {
        var e = $('input[name="Имя"]', $(this)).val(),
            t = $('input[name="Телефон"]', $(this)).val(),
            n = $('input[name="E-mail"]', $(this)).val(),
            i = $('textarea[name="Вопрос"]', $(this)).val(),
            r = {
                name: e,
                phone: t,
                email: n
            };
        return i && (r.comment = i),
            function() {
                var e = $(".button");
                e.attr("disabled", "disabled"), e.css("background-color", "gray"), e.css("cursor", "not-allowed")
            }(), $.ajax({
                type: "POST",
                url: "https://getrealprice.com/promosignup/",
                data: JSON.stringify(r),
                dataType: "json",
                crossDomain: !0,
                success: function() {
                    window.location.href = "/cheapers/thanks.html"
                },
                error: function(e, t, n) {
                    ! function() {
                        var e = $(".button");
                        e.removeAttr("disabled"), e.css("background-color", "#fc0a18"), e.css("cursor", "pointer")
                    }()
                }
            }), !1
    }), $(window).scroll(function() {
        $(this).scrollTop() > $(this).height() ? $(".btn__up_wrap").addClass("active") : $(".btn__up_wrap").removeClass("active")
    }), $(function() {
        $(window).scroll(function() {
            0 != $(this).scrollTop() ? $(".btn_up").fadeIn() : $(".btn_up").fadeOut()
